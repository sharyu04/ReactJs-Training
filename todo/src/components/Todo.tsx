...
const Todo = ({task, dueDate, completed, handleCheck, idx, removeTask}: {task: string, dueDate: string, completed: boolean, handleCheck: (id: number) => void, idx: number, removeTask: (id: number) => void}) => {
    return (
